...
def page_contact():
    ...
    with col1:
        st.markdown("""
            <div class="card">
                <h3 style="color: #0f172a;">📍 Notre Agence</h3>
                <p style="color: #1e293b;"><strong>🏢 Adresse:</strong><br>Cité 632 logements BT 28<br>El Mohammadia, Alger, Algérie</p>
                <p style="color: #1e293b;"><strong>📞 Téléphone:</strong><br>+213 783 80 27 12</p>
                <p style="color: #1e293b;"><strong>📧 Email:</strong><br>hcmvoyage1@gmail.com</p>
                <p style="color: #1e293b;"><strong>🕐 Horaires:</strong><br>Dim-Jeu: 9h-18h<br>Sam: 9h-13h</p>
            </div>
        ...
        st.markdown(f"""
            <div class="card" style="margin: 20px 0;">
                <div style="display: flex; align-items: center; margin-bottom: 15px;">
                    ...
                    <div>
                        <h2 style="color: #0f172a; margin: 0;">Visa {visa['pays']}</h2>
                        <p style="color: #1e293b; margin: 5px 0 0 0;">{visa['description']}</p>
                    </div>
                </div>
                ...
                st.markdown(f"""
                    <div class="card" style="margin: 10px 0;">
                        ...
                        <div>
                            ...
                            <span style="color: #1e293b; font-size: 0.9em;">{desc}</span>
                        </div>
                    </div>
                """, unsafe_allow_html=True)
        ...
        for idx, dest in enumerate(destinations_dz):
            ...
            with col:
                st.markdown(f"""
                    <div class="card">
                        <h3>🇩🇿 {dest['nom']}</h3>
                        <p style="min-height: 50px; color: #1e293b;">{dest['description']}</p>
...
def main():
    ...
    with st.sidebar:
        ...
        if st.session_state.get('admin_logged', False):
            stats = get_statistics()
            st.markdown(f"""
                <div style="background: rgba(59, 130, 246, 0.15); padding: 15px; border-radius: 10px; margin: 10px 0; border: 1px solid #3b82f6;">
                    <p style="margin: 5px 0; font-size: 0.9em; color: #0f172a; font-weight: 600;">📋 Réservations: <strong>{stats['total_reservations']}</strong></p>
                    <p style="margin: 5px 0; font-size: 0.9em; color: #0f172a; font-weight: 600;">⏳ En attente: <strong>{stats['reservations_en_attente']}</strong></p>
                    <p style="margin: 5px 0; font-size: 0.9em; color: #0f172a; font-weight: 600;">📧 Messages: <strong>{stats['messages_non_lus']}</strong></p>
                </div>
            """, unsafe_allow_html=True)
        
        st.markdown("---")
        st.markdown("""
            <div style="text-align: center; font-size: 0.8em; color: #0f172a; font-weight: 500;">
                © 2024 HCM Voyages<br>
